            ...
            for row_index, row_data in enumerate(rows):
                ...
                for col_index, row_tuple in enumerate(row_data.iterrows()):
                    with cols[col_index]:
                        ...
                        st.markdown(f"""
                            <div style="font-size: 0.8rem; line-height: 1.0; color: gray; text-align: center;">
                                <strong>{tiempo_parado_display}</strong>
                            </div>
                            <div style="font-size: 0.8rem; line-height: 1.0; color: black; text-align: center;">
                                <strong>...</strong>
                            </div>
                        """, unsafe_allow_html=True)

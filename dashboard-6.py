...
def get_current_unit_assignment(flota: str, unidad: str, version: int = 0) -> dict:
            ...
            for row_index, row_data in enumerate(rows):
                ...
                for col_index, row_tuple in enumerate(row_data.iterrows()):
                    with cols[col_index]:
                        ...
                        st.markdown(
                            f'<p style="text-align: center; margin-bottom: 10px; margin-top: 0px;">'
                            f'<span style="background-color: rgba(0,0,0,0.3); padding: 5px 10px; border-radius: 5px; font-size: 1.3em; font-weight: 900;">'
                            f'{nombre_unidad_display}'
                            f'</span>'
                            f'</p>',
                            unsafe_allow_html=True
